...
public class DettagliRichiestaVisita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dettagli_richiesta_visita);
        ...
        TextView tipoVisita = (TextView) findViewById(R.id.tipo_visita_richiesta);
        if(richiesta.getTipo().equals("s")){
            tipoVisita.setText("Visita Specialistica");
        } else {
            tipoVisita.setText("Visita di controllo");
        }

        TextView nomeVisitaSpecialistica = (TextView) findViewById(R.id.nome_visita_specialistica);
        nomeVisitaSpecialistica.setText(richiesta.getNome_farmaco());
        if(richiesta.getTipo().equals("c")) {
    ...
    public class AsyncCallSoapInfoPaziente extends AsyncTask<String, Void, Paziente> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(DettagliRichiestaVisita.this, "Waiting", "Recupero dati..", true);
        }
        ...
        protected void onPostExecute(Paziente s)
        {
            ...
            if(s.getCodiceFiscale()==null){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DettagliRichiestaVisita.this);
